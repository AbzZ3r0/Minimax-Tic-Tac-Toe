...
- **Provably optimal** — verified two ways: alpha-beta returns the identical
  ...
  self-play games the AI never loses *unless the seed position was already lost.*
...
*from the play phase onward*; it cannot rescue a position that is already lost.
